...
const NAV_ITEMS = [
    { label: "Souscription / Cotation", href: `/products/particuliers` },
    { label: "Sinis", href: `/products/entreprises` },
                            ...
                            {NAV_ITEMS.map((item) => (
                                <li key={item.href}>
                                    <button
                                        ...
                                        className="flex items-center justify-between w-full bg-cover text-left px-4 py-2 hover:bg-gray-100 text-gray-700"
                                        type="button"
                                    >
                                        {item.label}
                                    </button>
...
export default OnLineAssurPopup;
