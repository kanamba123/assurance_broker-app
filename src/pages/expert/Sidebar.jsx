...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { name: 'Paramètres', icon: CogIcon, path: '/admin/dashboard/settings', roles: ['admin','expert','user'] },
    { name: 'Message', icon: ChartBarIcon, path: '/expert/dashboard/message', roles: ['expert'] },
    { name: 'Demande', icon: GitPullRequestIcon, path: '/expert/dashboard/requests', roles: ['admin','expert','user'] },
